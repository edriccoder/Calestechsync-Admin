                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><a href="UserProfile.php" class="pull-right">UserProfile</a></h6>
                                        ...
                                        if ($num = mysqli_num_rows($run)>0) {  
                                            while ($result = mysqli_fetch_assoc($run)) {  
                                                echo "  
                                                    ...
                                                    <td>".$result['mname']."</td>  
                                                    <td>".$result['phone']."</td>  
                                                    <td><a href='UserProfile.php?userid=".$result['userid']."' id='btn'>Archive</a></td>
                                                    </tr>  
                                                    ";  
                                                }  
                                            }  
