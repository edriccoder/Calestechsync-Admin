...
<head>
    ...
    <title>SB Admin 2 - Exercise Records</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h2 class="m-0 font-weight-bold text-primary"><a href="ExerciseData.php" class="pull-right">See Records</a></h2>
                    <?php
                    include "conn.php";
                    if (isset($_SESSION['name'])) {
                        ?>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="exdesc" class="form-control" required="required"/>
                                            </div>
                                            <div class="form-group">
